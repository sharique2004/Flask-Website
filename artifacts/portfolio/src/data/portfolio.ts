...
export const FEATURED: Featured[] = [
  ...
  },
  {
    slug: "compiled-law",
    name: "Compiled Law",
    repo: "https://github.com/sharique2004/AlixHack",
    award: "Hackathon winner",
    kicker: "won the ALIX hackathon · california probate law in lean 4",
    line: "Either an LLM re-reads the statute on every query, or the statute is compiled once into code that is proven correct. This is both, side by side.",
    accent: "cyan",
    poster: null,
    title_html: "The LLM is the compiler, not the judge.",
    summary:
      "Same case, two ways to answer. One path sends every query to Gemini, which re-reads California probate law each time. The other runs the statute compiled once into proof checked Lean 4. Twelve audit agents derived the correct answer for each sample case straight from the court self help page and the Probate Code, then graded both engines: the Lean engine was right on all 12, while Gemini was right in 23 of 36 runs, and its mistakes were systematic rather than random. The compiled path answers in about 20 ms for a fraction of a cent, against 8 to 20 seconds and roughly a cent per query.",
    thesis: "Use the LLM once, at authoring time, to write the law into code. Then stop asking it.",
    tech: "Lean 4 · FastAPI · React · Gemini",
    stack: [
      ["lock", "Lean 4 proofs"],
      ["sparkles", "LLM authoring"],
      ["chart", "Head to head audit"],
      ["fastapi", "FastAPI"],
    ],
  },
  {
