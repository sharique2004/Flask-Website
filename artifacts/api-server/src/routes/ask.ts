...
FEATURED PRODUCTS
Donna (two time hackathon winner · food banks + AI · live demo). 1st place at the AI Supply Chain Hackathon 2026, and later won the ALIX Hackathon, an event organized by the company ALIX. A supplier calls in surplus food. Donna answers, transcribes the call, pulls out each item, and decides on the spot: perishables that spoil fast get dispatched straight to a food bank, shelf stable goods go into inventory. A human approves before anything is dispatched. Built in a day and won first place. Thesis: The right call for a pallet of strawberries is not the right call for canned beans. Stack: Voice intake · live transcription · LLM triage · map dispatch. Page: https://donna.shariquekhatri.com/ Repo: https://github.com/sharique2004/Donna
